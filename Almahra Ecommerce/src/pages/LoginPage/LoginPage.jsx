  ...
  const validateForm = () => {
    ...
    if (isLogin) {
      ...
      if (!formData.emailOrPhone) {
        ...
        const isPhone = /^\+?[\d\s\-()]+$/.test(formData.emailOrPhone.replace(/\s/g, ''));
        ...
        } else if (isPhone && formData.emailOrPhone.replace(/[\s\-()]/g, '').length < 10) {
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {isLogin ? (
            <div className="form-group">
              ...
              />
              {errors.emailOrPhone && <span className="form-error">{errors.emailOrPhone}</span>}
            </div>
          ) : (
            <div className="form-group">
